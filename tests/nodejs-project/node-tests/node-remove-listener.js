      ...
      switch (request) {
        case "dont-remove-listener-from-other-event":
          // not to do anything if no listeners have been added to that event
          {
            ...
            if (
              cordova.channel.eventNames().length !== 2 ||
              !cordova.channel.eventNames().includes("control") ||
              !cordova.channel.eventNames().includes("test-" + testName)
            ) {
              result =
                "ko: event listened to are not the expected when the test starts";
            }
            ...
            if (
              cordova.channel.eventNames().length !== 3 ||
              !cordova.channel.eventNames().includes("control") ||
              !cordova.channel.eventNames().includes("test-" + testName) ||
              ...
              result =
                "ko: events listened to are not the expected after adding echoListener";
            }
            ...
            if (
              ...
              result =
                "ko: events listened to are not the expected after removing from wrong event";
            }
          ...
          // remove a previously added listener
          {
            ...
            function echoListener(replyObj) {
              ...
              if (
                ...
                // Should still have listeners for echo.
                result =
                  "ko: events listened to are not the expected before removing the listener";
              }
              ...
              if (
                ...
                result =
                  "ko: event listened to are not the expected after removing the listener";
              }
              setTimeout(() => {
                cordova.channel.post("node-remove-listener-result", result);
        ...
        case "remove-one-listener-from-many":
          // remove one listener after multiple listeners have been added
          {
            ...
            if (
              ...
              result =
                "ko: events listened to are not the expected when the test starts";
            }
            ...
            function waitForInitialCallOnBothListeners() {
              if (totalListenerCalls == 2) {
                ...
                if (listener1Called !== 1 || listener2Called !== 1) {
                  result =
                    "ko: events were not called the expected number of times before removing a listener";
                }
                if (
                  !listener1Received.includes("foo") ||
                  listener1Received.includes("bar") ||
                  !listener2Received.includes("foo") ||
                  listener2Received.includes("bar")
                ) {
                  result =
                    "ko: events did not receive the expected values before removing a listener";
                }
                if (
                  cordova.channel.eventNames().length !== 3 ||
                  !cordova.channel.eventNames().includes("control") ||
                  ...
                  result =
                    "ko: events listened to are not the expected after adding the listeners";
                }
                // Remove listener2.
                ...
                setTimeout(() => {
                  if (
                    ...
                    result =
                      "ko: events were not called the expected number of times after removing a listener";
                  }
                  if (
                    !listener1Received.includes("foo") ||
                    !listener1Received.includes("bar") ||
                    ...
                    result =
                      "ko: events did not receive the expected values after removing a listener";
                  }
                  if (
                    cordova.channel.eventNames().length !== 3 ||
                    !cordova.channel.eventNames().includes("control") ||
                    ...
                    result =
                      "ko: events listened to are not the expected after removing a listener";
                  }
                  cordova.channel.post("node-remove-listener-result", result);
        ...
        default:
          cordova.channel.post(
            "node-remove-listener-result",
            "ko: unexpected test case",
          );
      }
    });
  }
