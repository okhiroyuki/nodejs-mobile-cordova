        ...
        case "do-nothing-no-listeners":
          // not do anything with no previous listeners added
          {
            ...
            if (cordova.channel.eventNames().length !== 0) {
              result =
                "ko: events were not clean after first removeAllListeners";
            }
            cordova.channel.removeAllListeners();
            if (cordova.channel.eventNames().length !== 0) {
              result =
                "ko: events were not clean after second removeAllListeners";
            }
            reinstateControl();
              ...
              if (totalListenerCalls == 2) {
                ...
                setTimeout(() => {
                  if (
                    ...
                    result =
                      "ko: events were not called the expected number of times after removing all listeners";
                  }
                  if (
                    !listener1Received.includes("foo") ||
                    listener1Received.includes("bar") ||
                    ...
                    result =
                      "ko: events did not receive the expected values after removing all listeners";
                  }
                  if (cordova.channel.eventNames().length !== 0) {
                    result =
